...
func xrc20GetTransfersFromLog(logs []*rpcLog) ([]bchain.Erc20Transfer, error) {
...
func xrc20GetTransfersFromTx(tx *rpcTransaction) ([]bchain.Erc20Transfer, error) {
	var r []bchain.Erc20Transfer
...
// EthereumTypeGetErc20ContractInfo returns information about xrc20 contract
func (b *CoreblockchainRPC) EthereumTypeGetErc20ContractInfo(contractDesc bchain.AddressDescriptor) (*bchain.Erc20Contract, error) {
